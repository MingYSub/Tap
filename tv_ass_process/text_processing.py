...
def clean_trash(text) -> str:
    TRASH_STR = ['', '\u3000', 'あわわ', 'あん', 'うぃ', 'うえぇ～ん', 'うお', 'うっわ',
                 ...
                 'ほ～ぅ', 'むふ', 'わぁぁ', 'ん', 'んあ', 'んぐぐ', 'んはは', 'んん', 'んんぃ',
                 'ぬあ', 'ほふぅ', 'ほふ', 'ふひゃ', 'うりゃ', 'ふ～ん', 'クックックッ']

    TRASH_RE = [r'[ウフ][ゥウッフプンー～]+', r'ふん(ふん)+', r'[アウハフワ][ァアッハー～]+', r'[うぐひふ][ぇえ]+',
                r'[うぐふ][ぅう]+', r'([うぐふわ]|うわ)[ぁあ]+', r'[あは][ぁあ][ぁあ]+', r'ひ[ぃい]+', r'[エヘ][ッヘー～]+',
                r'ヒ[ィイッヒー～]+', r'[うふ]ふ+', r'[ウクグワ][ァォオグッワー～]+', r'[うはほ]わ+ぁ*', r'ンフ+[ゥウッ]*']
